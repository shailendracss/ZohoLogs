...
public enum DriverType implements DriverSetup {
    ...
    CHROME {
        ...
        public RemoteWebDriver getWebDriverObject(MutableCapabilities capabilities) {
        	if(System.getProperty("webdriver.chrome.driver")==null){
        		System.setProperty("webdriver.chrome.driver", Constant.getChromeDriverLocation());
        	}
        	
        	/**
        	 * Added chromedriverservice for faster opening and closing of chrome
        	 * @author Shailendra 05-Jan-2020
        	 * */
        	return new RemoteWebDriver(DriverFactory.service.getUrl(), capabilities);
    ...
    CHROME_HEADLESS {
        public MutableCapabilities getDesiredCapabilities(Proxy proxySettings) {
            ...
            options.addArguments("--headless", "--disable-gpu", "--ignore-certificate-errors","--log-path=chromedriver.log", "--verbose","--user-agent=\"valid user agent :)\"");
