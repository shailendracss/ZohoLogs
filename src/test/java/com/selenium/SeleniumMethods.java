...
public class SeleniumMethods extends SelectCustom {
	...
	public boolean check_CheckboxAndConfirm(Object element, String objName) {
		...
		try {
			...
			if (bool) {
				Reporter.report(STATUS.PASS, "'" + objName + "' checkbox is successfully checked");
			} else {
				Reporter.report(STATUS.FAIL, "'" + objName + "' checkbox is NOT checked");
			}
		}
	...
	public boolean checkBlank(Object element, String objName) {
		...
		try {
			...
			if (bool) {
				Reporter.report(STATUS.PASS, "Value: '" + val + "' is filled in \"" + objName +"\" field");
			} else {
				Reporter.report(STATUS.FAIL,  "Value: '" + val + "' is Not filled in \"" + objName +"\" field");
			}
		}
		return bool;
	}
	...
	public boolean click(Object element, String desc) {
		...
		try {
			...
			if (!desc.equals("")) {
				if (bool) {
					Reporter.report(STATUS.PASS, "'" + desc + "' is clicked");
				} else {
					Reporter.report(STATUS.FAIL, "'" + desc + "' object is NOT clicked, due to some exception");
				}
			}
		}
		return bool;
	...
	public void contextClick_UsingAction(Object element, String desc) {
		...
		try {
			...
			if (!desc.equals("")) {
				if (bool) {
					Reporter.report(STATUS.PASS, "'" + desc + "' is context clicked");
				} else {
					Reporter.report(STATUS.FAIL, "'" + desc + "' object is NOT context clicked, due to some exception");
				}
			}
		}
	}
	...
	/**
	 * Close the current Thread's "BaseTest.getDriver()" Driver window, 
	...
	public void verifyTextFieldContainsValue(Object element, String txt) {
		...
		try {
			...
			if(val.toLowerCase().contains(txt.toLowerCase())) {
				Reporter.report(STATUS.PASS, txt +" is present in textfield");
			}else {
				Reporter.report(STATUS.FAIL, txt +" is NOT present in textfield");
			}
		} catch (Exception e) {
			new CustomExceptionHandler(e, element.toString()+" : "+txt);
		}
	}
	...
	public boolean isElementPresent(Object element, String desc) {
		...
		try {
			...
			if (!desc.equals("")) {
				if (reportFlag) {
					Reporter.report(STATUS.PASS, "'" + desc + "' is displayed");
				} else {
					Reporter.report(STATUS.FAIL, "'" + desc + "' is NOT displayed");
				}
			}
		}
	...
	public boolean isEnabled(Object element, String desc) {
		...
		try {
			...
			if (!desc.equals("")) {
				if (bool) {
					Reporter.report(STATUS.PASS, "'" + desc + "' is displayed as enabled");
				} else {
					Reporter.report(STATUS.FAIL, "'" + desc + "' is NOT displayed as enabled");
				}
			}
		}
		return bool;
	...
	public boolean isSelected(Object element, String desc) {
		...
		try {
			...
			if (!desc.equals("")) {
				if (bool) {
					Reporter.report(STATUS.PASS, "'" + desc + "' is displayed as selected");
				} else {
					Reporter.report(STATUS.FAIL, "'" + desc + "' is NOT displayed as selected");
				}
			}
		}
		return bool;
	...
	public boolean isClickable(Object element, long timeOutInSeconds, String desc) {
		...
		try {
			...
			if (!desc.equals("")) {
				if (bool) {
					Reporter.report(STATUS.PASS, "Element " + desc + " is clickable");
				} else {
					Reporter.report(STATUS.FAIL, "Element " + desc
	...
	public boolean navigateToAndVerifyPageTitle(Object element, String title) {
		Reporter.createNode("Navigating to ["+title+"] page");
		boolean bool = false;
	...
	public boolean uncheck_CheckboxAndConfirm(Object element, String objName) {
		...
		try {
			...
			if (bool) {
				Reporter.report(STATUS.PASS, "'" + objName + "' checkbox is successfully un-checked");
			} else {
				Reporter.report(STATUS.FAIL, "'" + objName + "' checkbox is NOT un-checked");
			}
		}
	...
	public boolean waitForElementTobe_NotVisible(Object element, long timeOutInSeconds, String desc) {
		...
		try {
			...
			if (!desc.equals("")) {
				if (bool) {
					Reporter.report(STATUS.PASS, desc + " is removed from the page");
				} else {
					Reporter.report(STATUS.FAIL,
	...
	public boolean waitForElementsTobe_NotVisible(Object element, long timeOutInSeconds, String desc) {
		...
		try {
			...
			if (!desc.equals("")) {
				if (bool) {
					Reporter.report(STATUS.PASS, "All Elements of " + desc + " are removed from the page");
				} else {
					Reporter.report(STATUS.FAIL, "All Elements of " + desc
	...
	public WebElement waitForElementTobe_Clickable(Object element, long timeoutSeconds, String desc) {
		...
		try {
			...
			if (!desc.equals("")) {
				if (bool) {
					Reporter.report(STATUS.PASS, desc + " is Clickable");
				} else {
					Reporter.report(STATUS.FAIL,
